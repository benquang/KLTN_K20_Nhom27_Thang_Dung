...
class CrawlplayersSpider(scrapy.Spider):
    name = "crawlPlayers_23"
    allowed_domains = ["sofifa.com"]
    
    custom_settings = {
        'FEEDS':{
            'player_attr_23.csv':{'format':'csv','overwrite':True}
            },
        'LOG_STDOUT' : {True},
        "LOG_FILE" :'./logs/crawlPlayers_23_log.txt',
        'DOWNLOAD_DELAY' : 0.5,
    ...
    def parse_on_versions(self,response):
        ...
        versions = ['/players?type=all&lg%5B0%5D=13&lg%5B1%5D=16&lg%5B2%5D=19&lg%5B3%5D=31&lg%5B4%5D=53&r=230054&set=true']
