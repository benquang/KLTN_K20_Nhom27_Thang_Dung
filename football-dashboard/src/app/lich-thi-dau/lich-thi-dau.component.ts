...
@Component({
  selector: 'app-lich-thi-dau',
  templateUrl: './lich-thi-dau.component.html',
  styleUrl: './lich-thi-dau.component.scss'
})
export class LichThiDauComponent {
  ...
  returnLinkFutureMatch(tag: string): string {
    ...
    return 'https://second-chariot-420108.firebaseapp.com' + '/upcoming/' + tag;
  }
  ...
  returnKetqua(tag: string): string {
    return 'https://second-chariot-420108.firebaseapp.com' + '/ket-qua/' + tag;
  }

  returnLichthidau(tag: string): string {
    return 'https://second-chariot-420108.firebaseapp.com' + '/lich-thi-dau/' + tag;
  }
  ...
  ngOnInit(): void {
    ...
    const csvFilePath = '/assets/View_Lich_Thi_Dau.csv';
